    ...
    def __init__(self,
        ...
        Args:
            ...
            deterministic: bool. whether to invoke the non-deterministic
                ...
                you could share with us the failing cases.
        """
        self.voxel_size = voxel_size # 体素size
        self.point_cloud_range = point_cloud_range # 点云范围
        self.max_num_points = max_num_points # 每个voxel最大点云个数
        self.max_voxels = max_voxels # 最大voxel个数
        self.deterministic = deterministic # TODO 新东西，后续再研究
        ...
        grid_size = torch.round(grid_size).long() # 计算grid大小
        ...
        # print(grid_size)
        # print(self.pcd_shape)
        # print(*input_feat_shape)
        # print([*input_feat_shape, 1])
